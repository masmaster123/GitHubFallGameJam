...
if(!roundLost){
	...
	if(roundTime >= 10.00 && spawnCounter == 1){
		SpawnPawns(obj_goblin,scaleRightX[0] + 32,dropHeight,16,0,2);
		SpawnWarning(scaleRightX[0] + 32,warningHeight,1,1,0);
		spawnCounter++;
	}

	if(roundTime >= 15.00 && spawnCounter == 2){
		SpawnPawns(obj_goblin,scaleRightX[0],dropHeight,16,16,2);
	...
	if(roundTime >= 20.00 && spawnCounter == 3){
		SpawnPawns(obj_goblin,scaleLeftX[0],dropHeight,8,16,4);
	...
	if(roundTime >= 25.00 && spawnCounter == 4){
		SpawnPawns(obj_goblin,scaleRightX[0],dropHeight,4,16,2);
		instance_create_layer(scaleRightX[0],warningHeight,"Instances",obj_warning);
		spawnCounter++;
	}
	
	if(roundTime >= 30.00 && spawnCounter == 5){
		SpawnPawns(obj_goblin,scaleRightX[1],dropHeight,4,16,6);
