draw_sprite_ext(spr_TimeBar,0,view_get_wport(0)/3.25,32,(roundTime/roundTimeLimit) * view_scale,view_scale,0,c_white,.75);
...
if(roundLost){
	...
	draw_text(view_get_wport(0)/2,view_get_hport(0)/4,"Press the right mouse button to restart the level");
}